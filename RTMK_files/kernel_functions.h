...
extern void TimerInt( void ); // empty TimerInt declaration
...
extern TCB *PreviousTask, *NextTask; /* Pointers to previous and next running tasks, TCB = Task Control Block */ 
